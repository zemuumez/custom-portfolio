...
import { ArrowLeft, Video, Palette, Layers, MessageSquare, Check, Award } from 'lucide-react';
...
const getAspectRatioClass = (category: ProjectCategory, mediaType?: 'image' | 'video') => {
...
const ProjectCardMedia = ({ project }: { project: Project }) => {
    ...
    const aspectRatioClass = getAspectRatioClass(project.category, project.mediaType);
             ...
             {isVideo && !isVisible && (
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-900 z-0 transition-opacity duration-300">
                     <div className="w-16 h-16 rounded-full border-2 border-white/10 flex items-center justify-center mb-4 shadow-[0_0_20px_rgba(0,0,0,0.5)] group-hover:scale-110 transition-transform duration-500">
                        <Video className="text-white opacity-50 group-hover:text-accent-gold group-hover:opacity-100 transition-colors" size={24} />
                     </div>
                     <span className="text-white/50 text-[10px] font-bold uppercase tracking-[0.25em] border-b border-white/10 pb-1 group-hover:text-white transition-colors">Click to Play</span>
                </div>
             )}
  ...
  return (
    <div className="relative min-h-screen bg-rich-black font-sans text-gray-200 animate-fade-in overflow-hidden selection:bg-accent-gold selection:text-black">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-[800px] h-[800px] bg-accent-gold rounded-full mix-blend-overlay blur-[120px] opacity-5 animate-pulse-slow" style={{animationDelay: '1s'}}></div>
      </div>
      ...
      <div className="relative z-10 pl-16 lg:pl-24">
        ...
        <section className="min-h-screen flex items-center pt-20 px-8 md:px-12">
            ...
            <div className="order-2 lg:order-1 reveal">
                <div className="inline-block mb-8">
                    <span className="text-accent-gold text-sm font-bold tracking-[0.2em] uppercase border-b border-accent-gold pb-2">Visual Artist & Designer</span>
                </div>
                ...
                <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-2xl leading-relaxed font-light">
                    Specializing in high-end brand identity, social media acceleration, and immersive video edits. A portfolio driven by results and aesthetics.
                </p>
            ...
            <div className="order-1 lg:order-2 flex justify-center lg:justify-end reveal" style={{ transitionDelay: '0.2s' }}>
        ...
        <section className="py-40 border-t border-white/5 bg-rich-black/40 backdrop-blur-sm">
            <div className="max-w-[1800px] mx-auto px-8 md:px-12">
                <h2 className="text-4xl md:text-5xl font-serif text-white mb-24 reveal text-center">My Quality Services</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
                    <div className="reveal p-12 border border-white/10 bg-black/40 hover:border-accent-gold/50 transition-colors group">
                        <Video size={48} className="text-accent-gold mb-8 group-hover:scale-110 transition-transform" strokeWidth={1} />
                        <h3 className="text-3xl font-serif text-white mb-6">Video Editing</h3>
                        <p className="text-gray-500 mb-8 leading-relaxed">Engaging short-form content for TikTok/Reels and cinematic long-form productions.</p>
                        <ul className="space-y-4 text-base text-gray-400 font-light">
                            <li className="flex gap-3"><Check size={18} className="text-accent-gold"/> Vertical Social Edits</li>
                            <li className="flex gap-3"><Check size={18} className="text-accent-gold"/> YouTube Thumbnails & Flow</li>
                            <li className="flex gap-3"><Check size={18} className="text-accent-gold"/> Motion Graphics</li>
                        </ul>
                    </div>

                    <div className="reveal p-12 border border-white/10 bg-black/40 hover:border-accent-gold/50 transition-colors group" style={{ transitionDelay: '0.15s' }}>
                        <Palette size={48} className="text-accent-gold mb-8 group-hover:scale-110 transition-transform" strokeWidth={1} />
                        <h3 className="text-3xl font-serif text-white mb-6">Brand Identity</h3>
                         <p className="text-gray-500 mb-8 leading-relaxed">Complete visual systems from logo design to corporate stationery and business cards.</p>
                        <ul className="space-y-4 text-base text-gray-400 font-light">
                            <li className="flex gap-3"><Check size={18} className="text-accent-gold"/> Logo Design</li>
                            <li className="flex gap-3"><Check size={18} className="text-accent-gold"/> Business Cards</li>
                            <li className="flex gap-3"><Check size={18} className="text-accent-gold"/> Brand Guidelines</li>
                        </ul>
                    </div>

                    <div className="reveal p-12 border border-white/10 bg-black/40 hover:border-accent-gold/50 transition-colors group" style={{ transitionDelay: '0.3s' }}>
                        <Layers size={48} className="text-accent-gold mb-8 group-hover:scale-110 transition-transform" strokeWidth={1} />
                        <h3 className="text-3xl font-serif text-white mb-6">Digital Design</h3>
                        <p className="text-gray-500 mb-8 leading-relaxed">High-conversion social media assets and intuitive UI/UX design for web and mobile.</p>
                        <ul className="space-y-4 text-base text-gray-400 font-light">
                            <li className="flex gap-3"><Check size={18} className="text-accent-gold"/> Social Media Posts</li>
                            <li className="flex gap-3"><Check size={18} className="text-accent-gold"/> UI / UX Prototyping</li>
                            <li className="flex gap-3"><Check size={18} className="text-accent-gold"/> Marketing Carousels</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        {/* Projects Section */}
        <section id="works" className="py-40 px-8 md:px-12 bg-rich-black/80 border-t border-white/5">
            <div className="max-w-[1800px] mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-end mb-24 reveal">
                    <div>
                        <h2 className="text-5xl md:text-7xl font-serif text-white mb-6">My Recent Works</h2>
                        <p className="text-xl text-gray-500 font-light">Curated selection from the creative archives.</p>
                    </div>
                    
                    {/* Filters */}
                    <div className="flex flex-wrap gap-4 mt-10 md:mt-0 text-base max-w-2xl justify-end">
                        {(['All', 'Videos', 'Logos', 'Business Cards', 'Social Media Posts', 'UI / UX', 'YouTube Thumbnails'] as ProjectCategory[]).map((category) => (
                            <button
                                key={category}
                    ...
                    {filteredProjects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="p-8 bg-charcoal z-10 border-t border-white/5">
                                <h3 className="text-2xl font-medium text-white mb-2 group-hover:text-accent-gold transition-colors">{project.title}</h3>
                                <div className="flex justify-between items-center">
                                    <p className="text-xs text-gray-500 uppercase tracking-wider">{project.category}</p>
                                    <ArrowLeft className="rotate-135 text-gray-600 group-hover:text-white transition-colors" size={16}/>
                                </div>
                            </div>
                        </div>
                    ))}
        ...
        <footer id="contact" className="bg-rich-black pt-40 pb-16 border-t border-white/5">
            <div className="max-w-[1800px] mx-auto px-8 md:px-12 grid lg:grid-cols-2 gap-24 items-start reveal">
                <div>
                    <h2 className="text-6xl md:text-8xl font-serif text-white mb-12 leading-none">
                        Ready to define <br/> <span className="text-gray-600 italic">your legacy?</span>
                    </h2>
                    <p className="text-gray-500 mb-16 max-w-xl text-2xl font-light">
                        Accepting new commissions for {new Date().getFullYear()}. Let's elevate your visual presence.
                    </p>
                    <div className="space-y-6">
                        <a href="mailto:officialnayad@gmail.com" className="text-3xl md:text-4xl text-white hover:text-accent-gold transition-colors block font-serif">officialnayad@gmail.com</a>
                    </div>
                </div>
                ...
                <div className="bg-charcoal p-12 md:p-16 border border-white/5">
                    <form className="space-y-10">
                        <div>
                            ...
                            <input type="text" className="w-full bg-rich-black border-b border-gray-700 text-white p-4 text-lg focus:border-white focus:outline-none transition-colors" placeholder="Your Name" />
                        </div>
                        <div>
                            <label className="block text-xs uppercase tracking-widest text-gray-500 mb-3">Email</label>
                            <input type="email" className="w-full bg-rich-black border-b border-gray-700 text-white p-4 text-lg focus:border-white focus:outline-none transition-colors" placeholder="email@example.com" />
                        </div>
                        <div>
                            <label className="block text-xs uppercase tracking-widest text-gray-500 mb-3">Project Details</label>
                            <textarea rows={4} className="w-full bg-rich-black border-b border-gray-700 text-white p-4 text-lg focus:border-white focus:outline-none transition-colors" placeholder="Tell me about your vision..."></textarea>
                        </div>
            ...
            <div className="max-w-[1800px] mx-auto px-8 md:px-12 mt-40 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-sm text-gray-600 uppercase tracking-widest">
                <div>© {new Date().getFullYear()} Nayad Tadesse.</div>
                <div className="flex gap-12 mt-6 md:mt-0">
                    <a href="https://t.me/eah0011" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">Telegram</a>
                    <a href="https://www.tiktok.com/@officialnayad" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">TikTok</a>
                    <a href="https://www.instagram.com/official__nayad/" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">Instagram</a>
