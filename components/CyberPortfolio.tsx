...
import { ArrowLeft, Terminal, Shield, Lock, Monitor, Database, Cpu, Activity, Server, Code, FileText, Wifi, Hash, Eye, Globe, Key } from 'lucide-react';
...
const allProjects: Project[] = [
  {
    ...
    description: 'A dedicated environment for analyzing Cross-Site Scripting vectors.',
    longDescription: 'A custom-built laboratory environment designed to simulate various Cross-Site Scripting (XSS) scenarios. Used for practicing payload injection, understanding reflected vs stored XSS, and developing mitigation strategies.',
    tags: ['JavaScript', 'Penetration Testing', 'Web Security', 'OWASP'],
    link: 'https://github.com/NAYAD-12/XSS_Lab.git'
  },
  {
    id: 'api-1',
    ...
    longDescription: 'A comprehensive dashboard application that integrates multiple external APIs. Fetches and visualizes real-time data for weather forecasts, cryptocurrency market trends, and global news headlines in a unified interface.',
    tags: ['API Integration', 'React/JS', 'Async', 'Frontend'],
    link: 'https://github.com/NAYAD-12/API-Based-App-Weather-Crypto-News-'
  },
  {
    id: 'auth-1',
    ...
    longDescription: 'A secure authentication framework handling user registration, login, and session management. Implements best practices for password hashing, token management, and protection against common auth-based attacks.',
    tags: ['Auth', 'Cryptography', 'Backend', 'Security'],
    link: 'https://github.com/NAYAD-12/Authentication-System'
  },
  {
    id: 'dev-1',
    ...
    longDescription: 'A productivity tool designed to generate and organize creative content ideas. Streamlines the content creation workflow by providing structured prompts and categories.',
    tags: ['Automation', 'Productivity', 'Scripting'],
    link: 'https://github.com/NAYAD-12/Content-Idea-Generator'
  },
  {
    id: 'fin-1',
    ...
    longDescription: 'An intuitive application for tracking daily expenses and managing personal budgets. Features transaction logging, category filtering, and summary views to monitor financial health.',
    tags: ['Finance', 'CRUD', 'State Management'],
    link: 'https://github.com/NAYAD-12/Expense_Tracker_v1'
  },
  {
    id: 'task-1',
    ...
    longDescription: 'A clean and efficient task management application. Allows users to create, update, and track daily tasks to improve productivity and maintain organized workflows.',
    tags: ['Productivity', 'React', 'UI/UX'],
    link: 'https://github.com/NAYAD-12/Daily_Task_Tracker_v1'
  }
];
...
const experience: ExperienceItem[] = [
    {
        ...
        description: 'Leading the offensive security division. Architecting zero-trust infrastructure for financial clients and conducting high-level red team engagements.',
    ...
    },
    {
        ...
        duration: '2021 - 2023',
        description: 'Implemented automated security pipelines. Hardened cloud infrastructure (AWS/Azure) and managed incident response protocols.',
  ...
  return (
    <div className="absolute top-0 right-0 w-full md:w-1/2 h-full overflow-hidden pointer-events-none opacity-5 font-mono text-xs text-neon-cyan z-0">
      <div className="p-8 md:p-12 flex flex-col justify-center h-full">
        {lines.map((line, i) => (
          <div key={i} className="whitespace-pre-wrap mb-1 font-light tracking-wide">
            <span className="text-gray-700 mr-4 select-none">{(i + 1).toString().padStart(3, '0')}</span>
            {line}
          </div>
        ))}
      </div>
      ...
      <div className="relative z-10 flex flex-col min-h-screen pl-16 lg:pl-24">
        ...
        <nav className="fixed top-0 w-full z-50 bg-[#020202]/95 backdrop-blur-sm border-b border-white/5 pl-24 transition-all duration-300">
          <div className="max-w-[1800px] mx-auto px-8 md:px-12 py-6 flex justify-between items-center">
            ...
            <div className="flex items-center gap-6">
                ...
                >
                  <ArrowLeft size={14} className="group-hover:-translate-x-1 transition-transform text-neon-cyan" /> 
                  // SYSTEM_EXIT
                </button>
                <div className="h-4 w-[1px] bg-gray-800"></div>
                <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-neon-cyan rounded-none animate-pulse"></div>
                    <span className="font-bold text-gray-200 tracking-tight text-sm">ALEX<span className="text-gray-600">_</span>DEV</span>
                </div>
            </div>
            ...
            <div className="max-w-[1800px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              ...
              <div className="order-2 lg:order-1 reveal">
                 ...
                 <p className="text-xl md:text-2xl text-gray-400 leading-relaxed font-mono max-w-2xl mb-12 border-l-2 border-neon-cyan/50 pl-8">
                    Building resilient digital infrastructure. Specializing in offensive security, cryptographic implementation, and high-performance backend systems.
                 </p>
                 ...
                 <div className="flex flex-wrap gap-8">
                    ...
                    >
                       View Operations <ArrowLeft className="rotate-[135deg]" size={16}/>
                    </button>
                    <button 
              ...
              <div className="order-1 lg:order-2 flex justify-center lg:justify-end reveal relative" style={{ transitionDelay: '0.2s' }}>
                  {/* Decorative Elements */}
        ...
        <section className="border-y border-white/5 bg-[#030303]">
           <div className="max-w-[1800px] mx-auto px-8 md:px-12 py-20 grid grid-cols-2 lg:grid-cols-4 gap-16">
              {[
                { label: 'Security Clearance', val: 'L3_ARCHITECT', icon: Shield },
                ...
                <div key={i} className="flex flex-col gap-4 border-l border-gray-800 pl-8 reveal group" style={{ transitionDelay: `${i * 100}ms` }}>
                   <stat.icon size={24} className="text-gray-600 group-hover:text-neon-cyan transition-colors" />
                   <div>
                       <span className="block text-xs text-gray-500 uppercase tracking-widest mb-2">{stat.label}</span>
                       <span className="block text-2xl font-bold text-white tracking-wider">{stat.val}</span>
                   </div>
                </div>
              ))}
           </div>
            ...
            <div className="max-w-[1800px] mx-auto">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 reveal">
                    ...
                    <p className="text-gray-500 text-lg max-w-xl mt-8 md:mt-0 font-mono text-right border-r border-neon-cyan pr-6">
                        // Deploying secure, scalable solutions.<br/>
                    ...
                    <div className="reveal group bg-[#080808] border border-gray-800 hover:border-neon-cyan/50 p-16 transition-all duration-500 relative overflow-hidden">
                         ...
                         <div className="relative z-10">
                            <h3 className="text-3xl font-bold text-white mb-8 flex items-center gap-4">
                                <span className="text-neon-cyan">01.</span> OFFENSIVE SECURITY
                            </h3>
                            <p className="text-lg text-gray-400 mb-12 leading-relaxed max-w-md">
                                Advanced penetration testing simulating real-world adversaries. I analyze network protocols, web applications, and cloud configurations to find the breaking point before others do.
                            </p>
                            <ul className="grid grid-cols-2 gap-6 text-sm text-gray-500 font-mono">
                                <li className="flex items-center gap-3 border-l border-gray-800 pl-4">Red Teaming</li>
                                <li className="flex items-center gap-3 border-l border-gray-800 pl-4">Social Engineering</li>
                                <li className="flex items-center gap-3 border-l border-gray-800 pl-4">Binary Exploitation</li>
                                <li className="flex items-center gap-3 border-l border-gray-800 pl-4">Cloud Audits</li>
                            </ul>
                        </div>
                    </div>

                    {/* Capability 2 */}
                     <div className="reveal group bg-[#080808] border border-gray-800 hover:border-neon-cyan/50 p-16 transition-all duration-500 relative overflow-hidden" style={{ transitionDelay: '0.2s' }}>
                         <div className="absolute top-0 right-0 p-16 opacity-5 group-hover:opacity-10 transition-opacity transform group-hover:scale-110 duration-700">
                             <Database size={250} />
                         </div>
                         <div className="relative z-10">
                            <h3 className="text-3xl font-bold text-white mb-8 flex items-center gap-4">
                                <span className="text-neon-cyan">02.</span> SECURE ARCHITECTURE
                            </h3>
                            <p className="text-lg text-gray-400 mb-12 leading-relaxed max-w-md">
                                Building systems that are secure by design. From Zero-Knowledge Proof authentication flows to hardened microservices architecture.
                            </p>
                            <ul className="grid grid-cols-2 gap-6 text-sm text-gray-500 font-mono">
                                <li className="flex items-center gap-3 border-l border-gray-800 pl-4">Cryptography</li>
                                <li className="flex items-center gap-3 border-l border-gray-800 pl-4">Microservices</li>
                                <li className="flex items-center gap-3 border-l border-gray-800 pl-4">API Design</li>
                                <li className="flex items-center gap-3 border-l border-gray-800 pl-4">DevSecOps</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section className="py-40 px-8 md:px-12 bg-[#050505] border-t border-white/5">
           <div className="max-w-[1800px] mx-auto grid lg:grid-cols-3 gap-24">
                <div className="lg:col-span-1 reveal">
                    <h2 className="text-4xl font-bold text-white mb-8">Mission Log</h2>
                    <p className="text-gray-500 text-lg leading-relaxed mb-12">
                        A chronological record of professional engagements and high-impact roles in the security and engineering sector.
                    </p>
                    <button className="text-neon-cyan text-sm uppercase tracking-widest hover:text-white transition-colors flex items-center gap-3">
                        Download Full Resume <ArrowLeft className="rotate-[-135deg]" size={16}/>
                    </button>
                </div>
                
                <div className="lg:col-span-2 space-y-16 reveal" style={{ transitionDelay: '0.2s' }}>
                    {experience.map((job, index) => (
                        <div key={job.id} className="relative pl-12 border-l border-gray-800 hover:border-neon-cyan transition-colors group">
                            ...
                            <div className="flex flex-col md:flex-row md:items-baseline justify-between mb-6">
                                <h3 className="text-3xl text-white font-bold">{job.role}</h3>
                                <span className="text-sm font-mono text-gray-500 mt-2 md:mt-0 border border-gray-800 px-3 py-1">{job.duration}</span>
                            </div>
                            
                            <div className="text-lg text-neon-cyan uppercase tracking-wider mb-6 font-bold">{job.company}</div>
                            <p className="text-lg text-gray-400 leading-relaxed max-w-4xl mb-8">{job.description}</p>
                            
                            <div className="flex flex-wrap gap-3">
                                {job.tools.map(tool => (
                                    <span key={tool} className="text-xs uppercase tracking-wider text-gray-500 border border-gray-800 px-4 py-2">
                                        {tool}
                                    </span>
                                ))}
                            </div>
        ...
        <section id="works" className="py-40 px-8 md:px-12">
            <div className="max-w-[1800px] mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-end mb-24 reveal">
                     <div>
                        <h2 className="text-5xl md:text-7xl font-bold text-white mb-6">Selected Modules</h2>
                        <div className="h-1 w-24 bg-neon-cyan"></div>
                     </div>
                     
                     <div className="flex gap-4 mt-10 md:mt-0 overflow-x-auto pb-4 md:pb-0">
                        {['All', 'Development', 'Offensive Security', 'Architecture'].map((cat) => (
                            <button
                                key={cat}
                    ...
                    {filteredProjects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="relative aspect-[4/3] overflow-hidden bg-[#0a0a0a] border-b border-gray-800 group-hover:border-neon-cyan/20 transition-colors">
                                ...
                                <div className={`absolute inset-0 bg-gradient-to-br from-black via-gray-900 to-[#050505] opacity-100`}></div>
                            ...
                            <div className="p-10">
                                <div className="flex justify-between items-start mb-4">
                                    <h3 className="text-2xl font-bold text-gray-200 group-hover:text-neon-cyan transition-colors font-sans tracking-tight">{project.title}</h3>
                                    <Code size={20} className="text-gray-700 group-hover:text-neon-cyan" />
                                </div>
                                <p className="text-sm text-gray-500 mb-8 line-clamp-2 leading-relaxed font-mono">{project.description}</p>
                                <div className="flex flex-wrap gap-2">
                                    {project.tags.slice(0,3).map(tag => (
                                        <span key={tag} className="text-[10px] uppercase tracking-wider text-gray-400 bg-gray-900/50 px-3 py-1">
                                            {tag}
                                        </span>
                                    ))}
                                </div>
        ...
        <footer id="contact" className="pt-40 pb-16 px-8 md:px-12 border-t border-white/5 bg-[#020202] relative">
            <div className="max-w-[1800px] mx-auto">
                <div className="grid lg:grid-cols-2 gap-24 reveal items-start">
                    ...
                    <div>
                        <h2 className="text-5xl md:text-7xl font-bold text-white mb-12 leading-none">
                            Initiate <br/><span className="text-neon-cyan">Encrypted</span> Channel
                        </h2>
                        <p className="text-gray-500 text-xl leading-relaxed mb-16 max-w-xl">
                            Available for high-stakes security consulting and full-stack architecture projects. Communications are secured via PGP.
                        </p>
                        <div className="space-y-8">
                             <div className="flex items-center gap-6 group cursor-pointer">
                                 <div className="w-16 h-16 bg-gray-900 flex items-center justify-center border border-gray-800 group-hover:border-neon-cyan transition-colors">
                                     <Wifi size={24} className="text-gray-400 group-hover:text-neon-cyan"/>
                                 </div>
                                 <div>
                                     <div className="text-xs uppercase text-gray-600 tracking-widest mb-1">Email Uplink</div>
                                     <div className="text-white font-mono text-xl">officialnayad@gmail.com</div>
                                 </div>
                             </div>
                             <div className="flex items-center gap-6 group cursor-pointer">
                                 <div className="w-16 h-16 bg-gray-900 flex items-center justify-center border border-gray-800 group-hover:border-neon-cyan transition-colors">
                                     <Key size={24} className="text-gray-400 group-hover:text-neon-cyan"/>
                                 </div>
                                 <div>
                                     <div className="text-xs uppercase text-gray-600 tracking-widest mb-1">Public Key</div>
                                     <div className="text-white font-mono text-xl">0x4F...9A21</div>
                                 </div>
                             </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#050505] border border-gray-800 p-12 md:p-16">
                        ...
                        <form className="space-y-8">
                            <div className="space-y-3">
                                ...
                                <input type="text" className="w-full bg-[#0a0a0a] border-b border-gray-800 text-white p-4 text-lg focus:border-neon-cyan focus:outline-none transition-colors font-mono" placeholder="NAME / ORG" />
                            </div>
                            <div className="space-y-3">
                                <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Coordinates</label>
                                <input type="email" className="w-full bg-[#0a0a0a] border-b border-gray-800 text-white p-4 text-lg focus:border-neon-cyan focus:outline-none transition-colors font-mono" placeholder="EMAIL_ADDRESS" />
                            </div>
                            <div className="space-y-3">
                                <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Payload</label>
                                <textarea rows={4} className="w-full bg-[#0a0a0a] border-b border-gray-800 text-white p-4 text-lg focus:border-neon-cyan focus:outline-none transition-colors font-mono" placeholder="MESSAGE_CONTENT"></textarea>
                            </div>
                ...
                <div className="mt-40 border-t border-gray-900 pt-10 flex flex-col md:flex-row justify-between items-center text-sm text-gray-600 uppercase tracking-widest font-mono">
                     ...
                     <div className="flex gap-12 mt-6 md:mt-0">
                         <a href="https://t.me/eah0011" target="_blank" rel="noreferrer" className="hover:text-neon-cyan transition-colors">Telegram</a>
                         <a href="https://www.tiktok.com/@officialnayad" target="_blank" rel="noreferrer" className="hover:text-neon-cyan transition-colors">TikTok</a>
                         <a href="https://www.instagram.com/official__nayad/" target="_blank" rel="noreferrer" className="hover:text-neon-cyan transition-colors">Instagram</a>
